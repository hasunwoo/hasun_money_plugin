 ...
 */
public class SimpleVirtualInventory implements Inventory {
    //넘친 아이템의 개수
    ...
    public SimpleVirtualInventory(Inventory inventory) {
        this.inv = inventory;
    ...
    public ListIterator<ItemStack> iterator() {
        return new InventoryIterator(new ArrayList<ItemStack>(clone.values()), size);
    }
